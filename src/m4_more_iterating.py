...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [8, 100, 500, 172, 1804, 240]
    threshold = 100
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([3, 6, 100, 20, -4, 0, -11])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 10
    actual = sum_first_n([1, 2, 3, 4, 5, 6, 7, 8], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
